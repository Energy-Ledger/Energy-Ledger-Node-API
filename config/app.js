...
module.exports = {
  ...
  */
  ...
  blockchainJsonRpcEndPoint: Env.get("BLOCKCHAIN_JSONRPC_ENDPOINT"),
  blockchainWebSocketEndPoint: Env.get("BLOCKCHAIN_WEBSOCKET_ENDPOINT"),
  supplyChainContractAddress: Env.get("SUPPLY_CHAIN_CONTRACT_ADDRESS"),
  firstBlockNumber: Env.get("FIRST_BLOCK_NUMBER"),
  ethContractAddress: Env.get("ETH_BRIDGE_CONTRACT_ADDRESS"),
  adminPrivKey: Env.get("ADMIN_WALLET_PRIVATE_KEY"),
  bscContractAddress: Env.get("BSC_BRIDGE_CONTRACT_ADDRESS"),
  ethBlockNumber: Env.get("ETH_FIRST_BLOCK_NUMBER"),
  blockchainETHInfuraKey: Env.get('ETH_INFURA_KEY'),
  blockchainETHInfuraNetwok : Env.get('ETH_INFURA_NETWORK'),
  ethElxContractAddress : Env.get('ETH_ELX_CONTRACT_ADDRESS')
